...
namespace byForm_Server.ku.byUser.Orm
{
    public class Orm0 : byForm_Server.ku.by.Object.orm
    {
        public override void SetValue(byForm_Server.ku.by.ToolClass.Sql.SelectTable f_SelectTable, byForm_Server.ku.by.Object.Row f_Row)
        {
            ...
            var tmpField2 = f_SelectTable.SelectItems[2];
            memberIndex2 = f_SelectTable.GetIndexOfField(tmpField2);
            var tmpField3 = f_SelectTable.SelectItems[3];
            memberIndex3 = f_SelectTable.GetIndexOfField(tmpField3);
            var tmpField4 = f_SelectTable.SelectItems[4];
            memberIndex4 = f_SelectTable.GetIndexOfField(tmpField4);
        ...
        public string Member2
        {
            get
            {
                return Convert.ToString(cells[memberIndex2].value);
            }
            set
            {
                this.cells[memberIndex2].SetValue(value);
            }
        }
        ...
        public string Member3
        {
            get
            {
                return Convert.ToString(cells[memberIndex3].value);
            }
            set
            {
                this.cells[memberIndex3].SetValue(value);
            }
        }

        public int memberIndex3;

        public string Member4
        {
            get
            {
                return Convert.ToString(cells[memberIndex4].value);
            }
            set
            {
                this.cells[memberIndex4].SetValue(value);
            }
        }

        public int memberIndex4;
        ...
        public static byForm_Server.ku.byUser.Orm.Orm0 Create(byForm_Server.ku.by.Object.Row f_Row0, byForm_Server.ku.by.Object.Row f_Row1)
        {
            var tmpOrm = new Orm0();
            ...
            Cell tmpNewCell2 = new Cell();
            tmpNewCell2.value = ToolFunction.CellValueNullToDefault(DataTypeEnum.String, null);
            tmpOrm.cells.add(tmpNewCell2);
            tmpOrm.memberIndex2 = tmpIndex++;
            Cell tmpNewCell3 = new Cell();
            tmpNewCell3.value = ToolFunction.CellValueNullToDefault(DataTypeEnum.String, null);
            tmpOrm.cells.add(tmpNewCell3);
            tmpOrm.memberIndex3 = tmpIndex++;
            Cell tmpNewCell4 = new Cell();
            tmpNewCell4.value = ToolFunction.CellValueNullToDefault(DataTypeEnum.String, null);
            tmpOrm.cells.add(tmpNewCell4);
            tmpOrm.memberIndex4 = tmpIndex++;
        ...
        public override System.Collections.Generic.List<byForm_Server.ku.by.ToolClass.OrmField> GenerateFieldMap()
        {
            ...
            tmpFields.Add(new OrmField("userIcoPath", memberIndex2));
            tmpFields.Add(new OrmField("iFileName", memberIndex3));
            tmpFields.Add(new OrmField("iExtendName", memberIndex4));
            return tmpFields;
        }
    }
}
