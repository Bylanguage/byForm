...
{
    public class OrmResult<T> : byForm_Server.ku.by.ToolClass.ITableSource, byForm_Server.ku.by.ToolClass.IExecItem where T : byForm_Server.ku.by.Object.orm
    {
        public byForm_Server.ku.by.Object.list<T> rows { get; set; }

        public byForm_Server.ku.by.ToolClass.Sql.SelectTable Source { get; set; }

        public System.Collections.Generic.List<byForm_Server.ku.by.Object.Row> RawRows { get; set; }
        ...
        public void FillDateset(System.Data.DataTable f_DataTable)
        {
            ...
            foreach (DataRow item in f_DataTable.Rows)
            {
