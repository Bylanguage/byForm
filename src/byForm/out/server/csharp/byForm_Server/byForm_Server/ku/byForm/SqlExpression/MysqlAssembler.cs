...
namespace byForm_Server.ku.byForm.SqlExpression
{
    public class MysqlAssembler
    {
        ...
        public static string _36(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            var tmpTable0 = f_Parameter.TableSourceList[0] as Table;
            ToolFunction.FillInsertValues(tmpInsertValues, f_Parameter.ParameterList[0], tmpTable0, DBTypeEnum.Mysql);
            tmpSql.Append(ToolFunction.GenerateSqlByInsertValues(tmpInsertValues, tmpTable0.Sheet, DBTypeEnum.Mysql));
            return tmpSql.ToString();
        }
        ...
        public static string Tran_0(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpTran.AppendLine("SET INNODB_LOCK_WAIT_TIMEOUT=3;\r\nDROP PROCEDURE IF EXISTS byForm_Tran_0;");
            tmpTran.AppendLine("CREATE PROCEDURE byForm_Tran_0()");
...
CALL byForm_Tran_0();");
        ...
        public static string Tran_1(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            StringBuilder tmpDec = new StringBuilder();
            StringBuilder tmpBody = new StringBuilder("START TRANSACTION;\r\n");
            tmpTran.AppendLine("SET INNODB_LOCK_WAIT_TIMEOUT=3;\r\nDROP PROCEDURE IF EXISTS byForm_Tran_1;");
            tmpTran.AppendLine("CREATE PROCEDURE byForm_Tran_1()");
            tmpTran.AppendLine(@"`tran` : BEGIN
DECLARE $EffectedCount INT;
...
CALL byForm_Tran_1();");
        ...
        public static string Tran_2(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            StringBuilder tmpDec = new StringBuilder();
            StringBuilder tmpBody = new StringBuilder("START TRANSACTION;\r\n");
            tmpTran.AppendLine("SET INNODB_LOCK_WAIT_TIMEOUT=3;\r\nDROP PROCEDURE IF EXISTS byForm_Tran_2;");
            tmpTran.AppendLine("CREATE PROCEDURE byForm_Tran_2()");
            tmpTran.AppendLine(@"`tran` : BEGIN
DECLARE $EffectedCount INT;
