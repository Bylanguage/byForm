...
namespace byForm_Server.ku.byBase.SqlExpression
{
    public class SqlserverAssembler
    {
        public static byForm_Server.ku.by.ToolClass.Sql.SelectTable _0(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            tmpWhere.Append(ToolFunction.TableRelationEqualQueryData(tmpTable0, (ku.by.Object.QueryData)f_Parameter.ParameterList[0], tmpHaving, tmpConfigJoinTableCount, DBTypeEnum.SqlServer, out tmpConfigJoinTableCount));
        ...
        public static byForm_Server.ku.by.ToolClass.Sql.SelectTable _11(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            tmpSql.Append(ToolFunction.GenerateSelectItemAndFrom(tmpMergedFieldList, tmpEquivalentTables, tmpFrom, false, tmpOrderByList, DBTypeEnum.SqlServer, false));
            tmpWhere.Append(" WHERE ");
            tmpWhere.Append(ToolFunction.TableRelationInRows((Table)tmpTable0,(IList<ku.by.Object.Row>)f_Parameter.ParameterList[0], DBTypeEnum.SqlServer));
            ToolFunction.GenerateSelectGroupBy(tmpGroupByFieldList, tmpGroupBy, tmpHaving, tmpMergedFieldList, DBTypeEnum.SqlServer);
            tmpSql.Append(tmpWhere);
            tmpSql.Append(tmpGroupBy);
            tmpSql.Append(tmpHaving);
        ...
        public static byForm_Server.ku.by.ToolClass.Sql.SelectTable _30(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            tmpSql.Append(ToolFunction.GenerateSelectItemAndFrom(tmpMergedFieldList, tmpEquivalentTables, tmpFrom, false, tmpOrderByList, DBTypeEnum.SqlServer, false));
            tmpWhere.Append(" WHERE ");
            tmpWhere.Append(ToolFunction.TableRelationEqualRow(tmpTable0, (ku.by.Object.Row)f_Parameter.ParameterList[0], DBTypeEnum.SqlServer));
            ToolFunction.GenerateSelectGroupBy(tmpGroupByFieldList, tmpGroupBy, tmpHaving, tmpMergedFieldList, DBTypeEnum.SqlServer);
            tmpSql.Append(tmpWhere);
            tmpSql.Append(tmpGroupBy);
            tmpSql.Append(tmpHaving);
        ...
        public static byForm_Server.ku.by.ToolClass.Sql.SelectTable _36(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            tmpWhere.Append(ToolFunction.TableRelationEqualQueryData(tmpTable0, (ku.by.Object.QueryData)f_Parameter.ParameterList[0], tmpHaving, tmpConfigJoinTableCount, DBTypeEnum.SqlServer, out tmpConfigJoinTableCount));
            tmpWhere.Append(" AND ");
            tmpWhere.Append(ToolFunction.TableRelationEqualRow(tmpTable0, (ku.by.Object.Row)f_Parameter.ParameterList[1], DBTypeEnum.SqlServer));
            ToolFunction.GenerateSelectGroupBy(tmpGroupByFieldList, tmpGroupBy, tmpHaving, tmpMergedFieldList, DBTypeEnum.SqlServer);
            tmpSql.Append(tmpWhere);
            tmpSql.Append(tmpGroupBy);
            tmpSql.Append(tmpHaving);
        ...
        public static string Tran_0(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpTran.AppendLine("DECLARE @tmpLineCount int");

            string tmpLocalDec_0 = _2(f_TranParmas.Paramters[0], "EffectedCount");
            tmpTran.Append(tmpLocalDec_0);
            tmpTran.AppendLine("SET @tmpLineCount = @EffectedCount");
            ...
            tmpTran.Append(_3(f_TranParmas.Paramters[1], "EffectedCount"));
            tmpTran.AppendLine();
        ...
        public static string Tran_1(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpTran.AppendLine(",16,0)\r\nROLLBACK\r\nRETURN");
            tmpTran.AppendLine("END");
            tmpTran.Append(_5(f_TranParmas.Paramters[1], "EffectedCount"));
            tmpTran.AppendLine();
            tmpTran.Append(_6(f_TranParmas.Paramters[2], "EffectedCount"));
            tmpTran.AppendLine();
            tmpTran.Append(_7(f_TranParmas.Paramters[3], "EffectedCount"));
            tmpTran.AppendLine();
            tmpTran.AppendLine("COMMIT TRAN");
            return tmpTran.ToString();
        }
        ...
        public static string Tran_2(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpTran.AppendLine(",16,0)\r\nROLLBACK\r\nRETURN");
            tmpTran.AppendLine("END");
            tmpTran.Append(_9(f_TranParmas.Paramters[1], "EffectedCount"));
            tmpTran.AppendLine();
            tmpTran.AppendLine("COMMIT TRAN");
            return tmpTran.ToString();
        }
        ...
        public static string Tran_3(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpTran.AppendLine("BEGIN TRAN");
            tmpTran.AppendLine("DECLARE @EffectedCount INT");
            tmpTran.Append(_14(f_TranParmas.Paramters[0], "EffectedCount"));
            tmpTran.AppendLine();
            tmpTran.Append(_15(f_TranParmas.Paramters[1], "EffectedCount"));
            tmpTran.AppendLine();
            tmpTran.AppendLine("COMMIT TRAN");
            return tmpTran.ToString();
        }
        ...
        public static string Tran_5(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpTran.AppendLine("BEGIN TRAN");
            tmpTran.AppendLine("DECLARE @EffectedCount INT");
            tmpTran.AppendLine("DECLARE @tmpTotal int");

            string tmpLocalDec_0 = _17(f_TranParmas.Paramters[0], "EffectedCount");
            tmpTran.Append(tmpLocalDec_0);
            tmpTran.AppendLine("SET @tmpTotal = @EffectedCount");

            tmpTran.AppendLine("DECLARE @tmpTotal2 int");

            string tmpLocalDec_1 = _18(f_TranParmas.Paramters[1], "EffectedCount");
            tmpTran.Append(tmpLocalDec_1);
            tmpTran.AppendLine("SET @tmpTotal2 = @EffectedCount");
        ...
        public static string Tran_7(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpTran.AppendLine("BEGIN TRAN");
            tmpTran.AppendLine("DECLARE @EffectedCount INT");
            tmpTran.Append(_22(f_TranParmas.Paramters[0], "EffectedCount"));
            tmpTran.AppendLine();
            tmpTran.AppendLine("COMMIT TRAN");
            return tmpTran.ToString();
        }
