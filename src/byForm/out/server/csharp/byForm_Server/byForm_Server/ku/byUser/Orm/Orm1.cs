...
{
    public class Orm1 : byForm_Server.ku.by.Object.orm
    {
        public override void SetValue(byForm_Server.ku.by.ToolClass.Sql.SelectTable f_SelectTable, byForm_Server.ku.by.Object.Row f_Row)
        {
            ...
            var tmpField1 = f_SelectTable.SelectItems[1];
        ...
        public string Member1
        {
            get
            {
                return Convert.ToString(cells[memberIndex1].value);
            }
            set
            {
                this.cells[memberIndex1].SetValue(value);
            }
        }
        ...
        public static byForm_Server.ku.byUser.Orm.Orm1 Create(byForm_Server.ku.by.Object.Row f_Row0)
        {
            var tmpOrm = new Orm1();
            ...
            Cell tmpNewCell1 = new Cell();
            tmpNewCell1.value = ToolFunction.CellValueNullToDefault(DataTypeEnum.String, null);
            tmpOrm.cells.add(tmpNewCell1);
            tmpOrm.memberIndex1 = tmpIndex++;
        ...
        public override System.Collections.Generic.List<byForm_Server.ku.by.ToolClass.OrmField> GenerateFieldMap()
        {
            ...
            tmpFields.Add(new OrmField("iName", memberIndex1));
            tmpFields.Add(new OrmField("iDisplayName", memberIndex2));
            tmpFields.Add(new OrmField("iMobile", memberIndex3));
            return tmpFields;
        }
    }
}
