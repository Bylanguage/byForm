    ...
    public class OracleAssembler
    {
        ...
        public static byForm_Server.ku.by.ToolClass.SqlIDUResult _2(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            StringBuilder tmpSql = new StringBuilder();
                ...
                tmpSql.AppendLine(@"CREATE OR REPLACE FUNCTION ""ORows$byUser$2""
    RETURN INT IS
    EFFECTCOUNT INT;
    BEGIN
    EFFECTCOUNT:= 0;");
            tmpSql.AppendLine(ToolFunction.InsertRowOrRowList(f_Parameter.ParameterList[0], tmpColList, DBTypeEnum.Oracle));
                return new SqlIDUResult(tmpSql.ToString(), "ORows$byUser$2", ToolFunction.GetDecKuFromRowOrRowList(f_Parameter.ParameterList[0]));
        ...
        public static byForm_Server.ku.by.ToolClass.SqlIDUResult _4(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            tmpTable0.Alias = "a";
            tmpSet.Append(" SET ");
            tmpSet.Append(ToolFunction.OracleSetAssignmentExpression((TableField)ToolFunction.ConvertFieldNameToField("a.iPassword", tmpTableList), "", SaveInspect.CharactorEscape(f_Parameter.ParameterList[0]), tmpSetFields, tmpSet));
        ...
        public static byForm_Server.ku.by.ToolClass.SqlIDUResult _31(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            StringBuilder tmpSql = new StringBuilder();
                ...
                tmpSql.AppendLine(@"CREATE OR REPLACE FUNCTION ""ORows$byUser$31""
    RETURN INT IS
    EFFECTCOUNT INT;
    BEGIN
    EFFECTCOUNT:= 0;");
            tmpSql.AppendLine(ToolFunction.InsertRowOrRowList(f_Parameter.ParameterList[0], tmpColList, DBTypeEnum.Oracle));
                return new SqlIDUResult(tmpSql.ToString(), "ORows$byUser$31", ToolFunction.GetDecKuFromRowOrRowList(f_Parameter.ParameterList[0]));
        ...
        public static byForm_Server.ku.by.ToolClass.SqlIDUResult _34(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            StringBuilder tmpSql = new StringBuilder();
                ...
                tmpSql.AppendLine(@"CREATE OR REPLACE FUNCTION ""ORows$byUser$34""
    RETURN INT IS
    EFFECTCOUNT INT;
    BEGIN
    EFFECTCOUNT:= 0;");
            tmpSql.AppendLine(ToolFunction.InsertRowOrRowList(f_Parameter.ParameterList[0], tmpColList, DBTypeEnum.Oracle));
                return new SqlIDUResult(tmpSql.ToString(), "ORows$byUser$34", ToolFunction.GetDecKuFromRowOrRowList(f_Parameter.ParameterList[0]));
        ...
        public static byForm_Server.ku.by.ToolClass.Sql.SelectTable _36(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            string tmpBinaryExpression1 = "CONCAT(" + SaveInspect.CharactorEscape("%") + " , " + SaveInspect.CharactorEscape(f_Parameter.ParameterList[0]) + ")";
            string tmpBinaryExpression0 = "CONCAT(" + tmpBinaryExpression1 + " , " + SaveInspect.CharactorEscape("%") + ")";            tmpWhere.Append(tmpBinaryExpression0);
            tmpWhere.Append(" OR ");
            tmpWhere.Append(ToolFunction.ConvertFieldNameToField("a.iName", tmpTableList).FieldAccess);
            tmpWhere.Append(" LIKE ");
            string tmpBinaryExpression3 = "CONCAT(" + SaveInspect.CharactorEscape("%") + " , " + SaveInspect.CharactorEscape(f_Parameter.ParameterList[0]) + ")";
            string tmpBinaryExpression2 = "CONCAT(" + tmpBinaryExpression3 + " , " + SaveInspect.CharactorEscape("%") + ")";            tmpWhere.Append(tmpBinaryExpression2);
            tmpWhere.Append(")");
            ToolFunction.GenerateSelectGroupBy(tmpGroupByFieldList, tmpGroupBy, tmpHaving, tmpMergedFieldList, DBTypeEnum.Oracle);
            tmpSql.Append(tmpWhere);
            tmpSql.Append(tmpGroupBy);
        ...
        public static byForm_Server.ku.by.ToolClass.Sql.SelectTable _38(byForm_Server.ku.by.ToolClass.Sql.ParamsPackage f_Parameter)
        {
            ...
            tmpTableList.Add(tmpTable0);
            tmpEquivalentTables.Add(tmpTable0);
            var tmpField0 = new FuncField("count", DataTypeEnum.None, null, DBTypeEnum.Oracle);
...
");
            ...
            tmpBody.AppendLine("\"tmpRowCount\" := SQL%ROWCOUNT;");
...
");
        ...
        public static string Tran_2(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpDec.AppendLine("\"EffectedCount\" NUMBER;");
            tmpDec.AppendLine(@"");
            tmpBody.Append(_27(f_TranParmas.Paramters[0], "EffectedCount"));
            tmpBody.Append(_28(f_TranParmas.Paramters[1], "EffectedCount"));
            tmpBody.Append("\r\nEND;");
            tmpTran.AppendLine(tmpDec.ToString());
            tmpTran.Append(tmpBody.ToString());
            return tmpTran.ToString();
        ...
        public static string Tran_3(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpDec.AppendLine("\"EffectedCount\" NUMBER;");
            tmpDec.AppendLine(@"");
            tmpBody.Append(_29(f_TranParmas.Paramters[0], "EffectedCount"));
            tmpBody.Append(_30(f_TranParmas.Paramters[1], "EffectedCount"));
            tmpBody.Append("\r\nEND;");
            tmpTran.AppendLine(tmpDec.ToString());
            tmpTran.Append(tmpBody.ToString());
            return tmpTran.ToString();
        ...
        public static string Tran_4(byForm_Server.ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas)
        {
            ...
            tmpDec.AppendLine("\"EffectedCount\" NUMBER;");
            tmpDec.AppendLine(@"");
            tmpBody.Append(_40(f_TranParmas.Paramters[0], "EffectedCount"));
            tmpBody.Append(_41(f_TranParmas.Paramters[1], "EffectedCount"));
            tmpBody.Append("\r\nEND;");
            tmpTran.AppendLine(tmpDec.ToString());
            tmpTran.Append(tmpBody.ToString());
            return tmpTran.ToString();
