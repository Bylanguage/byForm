...
{
    public class biao_userAdmin : byForm_Server.ku.by.Object.table, byForm_Server.ku.by.ToolClass.IBaseDataSheet
    {
        ...
        public string FlowString_insert(System.Collections.Generic.IList<byForm_Server.ku.by.Object.Row> f_Rows, params System.Collections.Generic.IList<byForm_Server.ku.by.Object.Row>[] f_RelationRow)
        {
            ...
            var tmpDataSheet = Root.GetInstance().KuDic["byUser"].DataSheetDic["userAdmin"];
        ...
        public biao_userAdmin()
        {
            try
            {
                ...
                VerifyDic.Add("userMode", new Dictionary<ku.by.Enum.attribute, string>());
                ...
                Fields.Add("iD", new field(this.FieldDic["iD"], "管理员ID"));
                FieldDic.Add("userMode", new Field(this.KuName, this.SheetName, "userMode", typeof(ku.byUser.Enum.adminMode)));
                ComponentDic.Add("iUserMode", this.FieldDic["userMode"]);
                Fields.Add("userMode", new field(this.FieldDic["userMode"], "管理员模式"));
                FieldDic.Add("dt", new Field(this.KuName, this.SheetName, "dt", ku.DataTypeEnum.Datetime));
                ComponentDic.Add("iDt", this.FieldDic["dt"]);
                Fields.Add("dt", new field(this.FieldDic["dt"], "加入时间"));
                ...
                SourceDic.Add("userMode", new by.ToolClass.Source(this, "equal",  FieldDic["userMode"]));
                ...
                FlowDic["insert"].Add(SourceDic["userMode"]);
                ...
                FlowDic["update"].Add(SourceDic["userMode"]);
                ...
                FlowDic["select"].Add(SourceDic["userMode"]);
                FlowDic.Add("popup", flow_popup);
                FlowDic["popup"].Add(SourceDic["iD"]);
                FlowDic["popup"].Add(SourceDic["userMode"]);
