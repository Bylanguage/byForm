...
import java.util.*;
public class biao$formField extends $Ku.by.Object.Table implements $Ku.by.ToolClass.IBaseDataSheet  {
    ...
    public biao$formField() {
        try {
            ...
            this.IdentityName = "byForm.formField";
            ...
            VerifyDic.put("form", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldNO", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldName", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldType", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldCtrl", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("selectValue", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            Integer selectValue_max = 1024;
            VerifyDic.get("selectValue").put($Ku.by.Enum.Attribute.max, selectValue_max.toString());
            VerifyDic.put("fieldMin", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldMax", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldReg", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldRegMsg", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldDefault", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("order", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("notNull", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("vDataValue", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            ...
            this.FieldDic.put("form", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "form", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iFormID", this.FieldDic.get("form"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("form")));
            this.FieldDic.put("fieldNO", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldNO", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iFieldNO", this.FieldDic.get("fieldNO"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldNO")));
            this.FieldDic.put("fieldName", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldName", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iFieldName", this.FieldDic.get("fieldName"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldName")));
            this.FieldDic.put("fieldType", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldType", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iFieldType", this.FieldDic.get("fieldType"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldType")));
            this.FieldDic.put("fieldCtrl", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldCtrl", $Ku.byForm.Enum.ctrType.class));
            this.ComponentDic.put("iFieldCtrl", this.FieldDic.get("fieldCtrl"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldCtrl")));
            this.FieldDic.put("selectValue", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "selectValue", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iSelectValue", this.FieldDic.get("selectValue"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("selectValue")));
            this.FieldDic.put("fieldMin", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldMin", $Ku.by.ToolClass.DataTypeEnum.Int));
            this.ComponentDic.put("iFieldMin", this.FieldDic.get("fieldMin"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldMin")));
            this.FieldDic.put("fieldMax", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldMax", $Ku.by.ToolClass.DataTypeEnum.Int));
            this.ComponentDic.put("iFieldMax", this.FieldDic.get("fieldMax"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldMax")));
            this.FieldDic.put("fieldReg", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldReg", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iFieldReg", this.FieldDic.get("fieldReg"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldReg")));
            this.FieldDic.put("fieldRegMsg", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldRegMsg", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iFieldRegMsg", this.FieldDic.get("fieldRegMsg"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldRegMsg")));
            this.FieldDic.put("fieldDefault", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldDefault", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iFieldDefault", this.FieldDic.get("fieldDefault"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldDefault")));
            this.FieldDic.put("order", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "order", $Ku.by.ToolClass.DataTypeEnum.Int));
            this.ComponentDic.put("iOrder", this.FieldDic.get("order"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("order")));
            this.FieldDic.put("notNull", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "notNull", $Ku.by.ToolClass.DataTypeEnum.Bool));
            this.ComponentDic.put("iNotNull", this.FieldDic.get("notNull"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("notNull")));
            this.FieldDic.put("vDataValue", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "vDataValue", $Ku.by.ToolClass.DataTypeEnum.Int));
            this.ComponentDic.put("iVDataValue", this.FieldDic.get("vDataValue"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("vDataValue")));
            ...
            this.SourceDic.put("form", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("form")));
            this.SourceDic.put("fieldNO", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldNO")));
            this.SourceDic.put("fieldName", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldName")));
            this.SourceDic.put("fieldType", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldType")));
            this.SourceDic.put("fieldCtrl", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldCtrl")));
            this.SourceDic.put("selectValue", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("selectValue")));
            this.SourceDic.put("fieldMin", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldMin")));
            this.SourceDic.put("fieldMax", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldMax")));
            this.SourceDic.put("fieldReg", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldReg")));
            this.SourceDic.put("fieldRegMsg", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldRegMsg")));
            this.SourceDic.put("fieldDefault", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldDefault")));
            this.SourceDic.put("vDataValue", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("vDataValue")));
            ...
            this.SourceDic.put("order", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("order")));
            this.SourceDic.put("notNull", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("notNull")));
            ...
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldNO"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldName"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldType"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldCtrl"));
            this.FlowDic.get("insert").add(this.SourceDic.get("selectValue"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldMin"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldMax"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldReg"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldRegMsg"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldDefault"));
            this.FlowDic.get("insert").add(this.SourceDic.get("vDataValue"));
            this.FlowDic.get("insert").add(this.SourceDic.get("form"));
            this.FlowDic.get("insert").add(this.SourceDic.get("userID"));
            this.FlowDic.get("insert").add(this.SourceDic.get("summary"));
            this.FlowDic.get("insert").add(this.SourceDic.get("order"));
            this.FlowDic.get("insert").add(this.SourceDic.get("notNull"));
            ...
            this.FlowDic.get("update").add(this.SourceDic.get("fieldNO"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldName"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldType"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldCtrl"));
            this.FlowDic.get("update").add(this.SourceDic.get("selectValue"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldMin"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldMax"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldReg"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldRegMsg"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldDefault"));
            this.FlowDic.get("update").add(this.SourceDic.get("vDataValue"));
            this.FlowDic.get("update").add(this.SourceDic.get("form"));
            this.FlowDic.get("update").add(this.SourceDic.get("userID"));
            this.FlowDic.get("update").add(this.SourceDic.get("order"));
            this.FlowDic.get("update").add(this.SourceDic.get("notNull"));
            ...
            this.FlowDic.get("delete").add(this.SourceDic.get("summary"));
            this.FlowDic.put("select", flow$select);
            this.FlowDic.get("select").add(this.SourceDic.get("iD"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldNO"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldName"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldType"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldCtrl"));
            this.FlowDic.get("select").add(this.SourceDic.get("selectValue"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldMin"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldMax"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldReg"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldRegMsg"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldDefault"));
            this.FlowDic.get("select").add(this.SourceDic.get("vDataValue"));
            this.FlowDic.get("select").add(this.SourceDic.get("form"));
            this.FlowDic.get("select").add(this.SourceDic.get("userID"));
            this.FlowDic.get("select").add(this.SourceDic.get("summary"));
            this.FlowDic.get("select").add(this.SourceDic.get("order"));
            this.FlowDic.get("select").add(this.SourceDic.get("notNull"));
            this.FlowDic.put("popup", flow$popup);
            this.FlowDic.get("popup").add(this.SourceDic.get("iD"));
            this.FlowDic.get("popup").add(this.SourceDic.get("form"));
            this.FlowDic.get("popup").add(this.SourceDic.get("userID"));
            this.FlowDic.get("popup").add(this.SourceDic.get("summary"));
            this.FlowDic.get("popup").add(this.SourceDic.get("order"));
            this.FlowDic.get("popup").add(this.SourceDic.get("notNull"));
    ...
    public java.lang.String FlowString$insert(java.lang.Iterable<$Ku.by.Object.Row> f_Rows, java.lang.Iterable<$Ku.by.Object.Row> ... f_RelationRow) {
        ...
        biao$formField tmpDataSheet = (biao$formField)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formField");
...
biao$formField tmpDataSheet = (biao$formField)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formField");
    ...
    public java.lang.String FlowStringInTran$insert(java.lang.String f_EffectCount, java.lang.Iterable<$Ku.by.Object.Row> f_CurrentRow, java.lang.Iterable<$Ku.by.Object.Row> ... f_RelationRow) {
        ...
        java.util.ArrayList<java.util.List<$Ku.by.Object.Row>> tmpRelationRowCopy = ToolFunction.CopyRowsArray((java.util.List<$Ku.by.Object.Row>[]) f_RelationRow);
        StringBuilder tmpSql = new StringBuilder();String[] tmpColumns = { "iD", "fieldNO", "fieldName", "fieldType", "fieldCtrl", "selectValue", "fieldMin", "fieldMax", "fieldReg", "fieldRegMsg", "fieldDefault", "vDataValue", "form", "userID", "summary", "order", "notNull" };
        biao$formField tmpDataSheet = (biao$formField)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formField");
        for(int i = 0; i < tmpRowsCopy.size(); i++){
            $Ku.by.Object.Row tmpRow = tmpRowsCopy.get(i);
            if (!Objects.equals(tmpRow.getKuName(), this.KuName) || !Objects.equals(tmpRow.getSheetName(), this.SheetName)){
...
biao$formField tmpDataSheet = (biao$formField)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formField");
    ...
    public java.lang.String FlowStringInTran$update(java.lang.String f_EffectCount, java.lang.Iterable<$Ku.by.Object.Row> f_CurrentRow, java.lang.Iterable<$Ku.by.Object.Row> ... f_RelationRow) {
        ...
        java.util.ArrayList<$Ku.by.Object.Row> tmpRowsCopy = ToolFunction.CopyRows(f_CurrentRow);
        java.util.ArrayList<java.util.List<$Ku.by.Object.Row>> tmpRelationRowCopy = ToolFunction.CopyRowsArray((java.util.List<$Ku.by.Object.Row>[]) f_RelationRow);
        StringBuilder tmpSql = new StringBuilder();String[] tmpColumns = { "fieldNO", "fieldName", "fieldType", "fieldCtrl", "selectValue", "fieldMin", "fieldMax", "fieldReg", "fieldRegMsg", "fieldDefault", "vDataValue", "form", "userID", "order", "notNull" };
        biao$formField tmpDataSheet = (biao$formField)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formField");
        for(int i = 0; i < tmpRowsCopy.size(); i++){
            $Ku.by.Object.Row tmpRow = tmpRowsCopy.get(i);
            if (!Objects.equals(tmpRow.getKuName(), this.KuName) || !Objects.equals(tmpRow.getSheetName(), this.SheetName)){
...
biao$formField tmpDataSheet = (biao$formField)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formField");
    ...
    public java.lang.String FlowStringInTran$delete(java.lang.String f_EffectCount, java.lang.Iterable<$Ku.by.Object.Row> f_CurrentRow, java.lang.Iterable<$Ku.by.Object.Row> ... f_RelationRow) {
        ...
        java.util.ArrayList<$Ku.by.Object.Row> tmpRowsCopy = ToolFunction.CopyRows(f_CurrentRow);
        java.util.ArrayList<java.util.List<$Ku.by.Object.Row>> tmpRelationRowCopy = ToolFunction.CopyRowsArray((java.util.List<$Ku.by.Object.Row>[]) f_RelationRow);
        StringBuilder tmpSql = new StringBuilder();String[] tmpColumns = { "iD", "summary" };
        biao$formField tmpDataSheet = (biao$formField)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formField");
        for(int i = 0; i < tmpRowsCopy.size(); i++){
            $Ku.by.Object.Row tmpRow = tmpRowsCopy.get(i);
            if (!Objects.equals(tmpRow.getKuName(), this.KuName) || !Objects.equals(tmpRow.getSheetName(), this.SheetName)){
    ...
    public void assembleFieldReference() {
        this.FieldDic.get("form").ReferenceField = $Ku.by.ToolClass.Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("form").getFieldDic().get("iD");
    }
}
