...
import java.util.*;
public class biao$formData extends $Ku.by.Object.Table implements $Ku.by.ToolClass.IBaseDataSheet  {
    ...
    public biao$formData() {
        try {
            ...
            this.IdentityName = "byForm.formData";
            ...
            VerifyDic.put("rowPK", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldID", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("fieldName", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            VerifyDic.put("cellValue", new java.util.LinkedHashMap<$Ku.by.Enum.Attribute, String>());
            Integer cellValue_max = 4000;
            VerifyDic.get("cellValue").put($Ku.by.Enum.Attribute.max, cellValue_max.toString());
            ...
            this.FieldDic.put("rowPK", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "rowPK", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iRowPK", this.FieldDic.get("rowPK"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("rowPK")));
            this.FieldDic.put("fieldID", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "fieldID", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iFieldID", this.FieldDic.get("fieldID"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("fieldID")));
            ...
            this.FieldDic.put("cellValue", new $Ku.by.ToolClass.Sql.SqlField(this.KuName, this.SheetName, "cellValue", $Ku.by.ToolClass.DataTypeEnum.String));
            this.ComponentDic.put("iCellValue", this.FieldDic.get("cellValue"));
            tmpFields.add(new $Ku.by.Object.Field(this.FieldDic.get("cellValue")));
            ...
            this.SourceDic.put("formID", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("formID")));
            this.SourceDic.put("rowPK", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("rowPK")));
            this.SourceDic.put("fieldID", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldID")));
            this.SourceDic.put("fieldName", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("fieldName")));
            this.SourceDic.put("cellValue", new $Ku.by.ToolClass.Source(this, "equal", FieldDic.get("cellValue")));
            ...
            this.FlowDic.get("insert").add(this.SourceDic.get("formID"));
            this.FlowDic.get("insert").add(this.SourceDic.get("rowPK"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldID"));
            this.FlowDic.get("insert").add(this.SourceDic.get("fieldName"));
            this.FlowDic.get("insert").add(this.SourceDic.get("cellValue"));
            ...
            this.FlowDic.get("update").add(this.SourceDic.get("formID"));
            this.FlowDic.get("update").add(this.SourceDic.get("rowPK"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldID"));
            this.FlowDic.get("update").add(this.SourceDic.get("fieldName"));
            this.FlowDic.get("update").add(this.SourceDic.get("cellValue"));
            ...
            this.FlowDic.get("select").add(this.SourceDic.get("formID"));
            this.FlowDic.get("select").add(this.SourceDic.get("rowPK"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldName"));
            this.FlowDic.get("select").add(this.SourceDic.get("fieldID"));
            this.FlowDic.get("select").add(this.SourceDic.get("cellValue"));
    ...
    public java.lang.String FlowString$insert(java.lang.Iterable<$Ku.by.Object.Row> f_Rows, java.lang.Iterable<$Ku.by.Object.Row> ... f_RelationRow) {
        ...
        biao$formData tmpDataSheet = (biao$formData)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formData");
...
biao$formData tmpDataSheet = (biao$formData)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formData");
    ...
    public java.lang.String FlowStringInTran$insert(java.lang.String f_EffectCount, java.lang.Iterable<$Ku.by.Object.Row> f_CurrentRow, java.lang.Iterable<$Ku.by.Object.Row> ... f_RelationRow) {
        ...
        java.util.ArrayList<java.util.List<$Ku.by.Object.Row>> tmpRelationRowCopy = ToolFunction.CopyRowsArray((java.util.List<$Ku.by.Object.Row>[]) f_RelationRow);
        StringBuilder tmpSql = new StringBuilder();String[] tmpColumns = { "iD", "formID", "rowPK", "fieldID", "fieldName", "cellValue", "userID" };
        biao$formData tmpDataSheet = (biao$formData)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formData");
        for(int i = 0; i < tmpRowsCopy.size(); i++){
            $Ku.by.Object.Row tmpRow = tmpRowsCopy.get(i);
            if (!Objects.equals(tmpRow.getKuName(), this.KuName) || !Objects.equals(tmpRow.getSheetName(), this.SheetName)){
...
biao$formData tmpDataSheet = (biao$formData)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formData");
    ...
    public java.lang.String FlowStringInTran$update(java.lang.String f_EffectCount, java.lang.Iterable<$Ku.by.Object.Row> f_CurrentRow, java.lang.Iterable<$Ku.by.Object.Row> ... f_RelationRow) {
        ...
        java.util.ArrayList<$Ku.by.Object.Row> tmpRowsCopy = ToolFunction.CopyRows(f_CurrentRow);
        java.util.ArrayList<java.util.List<$Ku.by.Object.Row>> tmpRelationRowCopy = ToolFunction.CopyRowsArray((java.util.List<$Ku.by.Object.Row>[]) f_RelationRow);
        StringBuilder tmpSql = new StringBuilder();String[] tmpColumns = { "formID", "rowPK", "fieldID", "fieldName", "cellValue", "userID" };
        biao$formData tmpDataSheet = (biao$formData)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formData");
        for(int i = 0; i < tmpRowsCopy.size(); i++){
            $Ku.by.Object.Row tmpRow = tmpRowsCopy.get(i);
            if (!Objects.equals(tmpRow.getKuName(), this.KuName) || !Objects.equals(tmpRow.getSheetName(), this.SheetName)){
...
biao$formData tmpDataSheet = (biao$formData)Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formData");
    ...
    public void assembleFieldReference() {
        this.FieldDic.get("formID").ReferenceField = $Ku.by.ToolClass.Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("form").getFieldDic().get("iD");
        this.FieldDic.get("fieldID").ReferenceField = $Ku.by.ToolClass.Root.GetInstance().KuDic.get("byFormNew").DataSheetDic.get("formField").getFieldDic().get("iD");
