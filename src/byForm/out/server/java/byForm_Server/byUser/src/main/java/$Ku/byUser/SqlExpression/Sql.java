...
public class Sql {
    ...
    public static $Ku.by.ToolClass.Sql.SelectTable _22($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter) {
        ...
        $Ku.by.ToolClass.DBTypeEnum tmpDBType = $Ku.by.ToolClass.Root.GetInstance().KuTypeDic.get(tmpKuName);
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._22(f_Parameter);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._22(f_Parameter);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._22(f_Parameter);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static java.lang.String _27($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter, java.lang.String f_EffectedCount) {
        ...
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._27(f_Parameter, f_EffectedCount);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._27(f_Parameter, f_EffectedCount);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._27(f_Parameter, f_EffectedCount);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static java.lang.String _28($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter, java.lang.String f_EffectedCount) {
        ...
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._28(f_Parameter, f_EffectedCount);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._28(f_Parameter, f_EffectedCount);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._28(f_Parameter, f_EffectedCount);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static java.lang.String _29($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter, java.lang.String f_EffectedCount) {
        ...
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._29(f_Parameter, f_EffectedCount);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._29(f_Parameter, f_EffectedCount);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._29(f_Parameter, f_EffectedCount);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static java.lang.String _30($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter, java.lang.String f_EffectedCount) {
        ...
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._30(f_Parameter, f_EffectedCount);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._30(f_Parameter, f_EffectedCount);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._30(f_Parameter, f_EffectedCount);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static $Ku.by.ToolClass.Sql.SelectTable _32($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter) {
        ...
        $Ku.by.ToolClass.DBTypeEnum tmpDBType = $Ku.by.ToolClass.Root.GetInstance().KuTypeDic.get(tmpKuName);
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._32(f_Parameter);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._32(f_Parameter);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._32(f_Parameter);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static $Ku.by.ToolClass.Sql.SelectTable _38($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter) {
        ...
        $Ku.by.ToolClass.DBTypeEnum tmpDBType = $Ku.by.ToolClass.Root.GetInstance().KuTypeDic.get(tmpKuName);
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._38(f_Parameter);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._38(f_Parameter);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._38(f_Parameter);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static $Ku.by.ToolClass.Sql.SelectTable _39($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter) {
        ...
        $Ku.by.ToolClass.DBTypeEnum tmpDBType = $Ku.by.ToolClass.Root.GetInstance().KuTypeDic.get(tmpKuName);
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._39(f_Parameter);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._39(f_Parameter);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._39(f_Parameter);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static java.lang.String _40($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter, java.lang.String f_EffectedCount) {
        ...
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._40(f_Parameter, f_EffectedCount);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._40(f_Parameter, f_EffectedCount);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._40(f_Parameter, f_EffectedCount);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static java.lang.String _41($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter, java.lang.String f_EffectedCount) {
        ...
        if (tmpDBType == DBTypeEnum.SqlServer){
            return SqlserverAssembler._41(f_Parameter, f_EffectedCount);
        }
        else if(tmpDBType == DBTypeEnum.Mysql){
            return MysqlAssembler._41(f_Parameter, f_EffectedCount);
        }        
        else if(tmpDBType == DBTypeEnum.Oracle){
            return OracleAssembler._41(f_Parameter, f_EffectedCount);
        }
        else
        {
            throw new RuntimeException(ErrorInfo.UnsupportedDatabaseError);
    ...
    public static java.lang.String[] Tran_3($Ku.by.ToolClass.Sql.TranParamsPackage f_Parameter) {
        String tmpKuName = ToolFunction.GetKuInSql(f_Parameter);
        $Ku.by.ToolClass.DBTypeEnum tmpDBType = $Ku.by.ToolClass.Root.GetInstance().KuTypeDic.get(tmpKuName);
    ...
    public static java.lang.String[] Tran_4($Ku.by.ToolClass.Sql.TranParamsPackage f_Parameter) {
        String tmpKuName = ToolFunction.GetKuInSql(f_Parameter);
        $Ku.by.ToolClass.DBTypeEnum tmpDBType = $Ku.by.ToolClass.Root.GetInstance().KuTypeDic.get(tmpKuName);
