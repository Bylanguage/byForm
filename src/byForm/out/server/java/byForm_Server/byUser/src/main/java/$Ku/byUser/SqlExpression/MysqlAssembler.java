...
public class MysqlAssembler {
    public static $Ku.by.ToolClass.Sql.SelectTable _0($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter) {
        ...
        tmpField1.tmpDB = DBTypeEnum.Mysql;
    ...
    public static java.lang.String _4($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter) {
        ...
        tmpSet.append(ToolFunction.SetAssignmentExpression((TableField)ToolFunction.ConvertFieldNameToField("a.iPassword", tmpTableList), " = ", SaveInspect.CharactorEscape(f_Parameter.getParameterList().get(0)), tmpSetFields,DBTypeEnum.Mysql));
        tmpWhere.append(" WHERE ");
    ...
    public static $Ku.by.ToolClass.Sql.SelectTable _38($Ku.by.ToolClass.Sql.ParamsPackage f_Parameter) {
        ...
        tmpTableList.add(tmpTable0);
        tmpEquivalentTables.add(tmpTable0);
        FuncField tmpField0 = new FuncField("count", DataTypeEnum.None, null, DBTypeEnum.Mysql);
    ...
    public static java.lang.String[] Tran_0($Ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas) {
        ...
        result.add("DROP PROCEDURE IF EXISTS byUser_Tran_0;\r\n");
        tmpTran.append("CREATE PROCEDURE byUser_Tran_0()\r\n");
        ...
        tmpBody.append("SET $tmpRowCount = ROW_COUNT();\r\n");
    ...
    public static java.lang.String[] Tran_1($Ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas) {
        ...
        tmpTran.append("SET GLOBAL innodb_lock_wait_timeout = 50;\r\n");
        StringBuilder tmpBody = new StringBuilder("START TRANSACTION;\r\n");
        result.add("DROP PROCEDURE IF EXISTS byUser_Tran_1;\r\n");
        tmpTran.append("CREATE PROCEDURE byUser_Tran_1()\r\n");
        tmpTran.append("`tran` : BEGIN\r\n");
        tmpTran.append("DECLARE $EffectedCount INT;\r\n");
        tmpTran.append("DECLARE $tmpRowCount INT;\r\n");
        ...
        tmpBody.append(";\r\n");
        tmpBody.append("END IF;\r\n");
        String tmpLocalDec_3 = _21(f_TranParmas.getParamters().get(1), "EffectedCount");

        tmpBody.append(tmpLocalDec_3);
        tmpBody.append("SET ");
        ...
        tmpBody.append(";\r\n");
        tmpBody.append("\r\nIF ");
        String tmpLocalDec_4 = "$tmpRowCount";
        String tmpLocalDec_5 = "1";
        tmpBody.append(ToolFunction.NotEqualExpression(tmpLocalDec_4, tmpLocalDec_5));
    ...
    public static java.lang.String[] Tran_2($Ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas) {
        ...
        tmpTran.append("SET GLOBAL innodb_lock_wait_timeout = 50;\r\n");
        StringBuilder tmpBody = new StringBuilder("START TRANSACTION;\r\n");
        result.add("DROP PROCEDURE IF EXISTS byUser_Tran_2;\r\n");
        tmpTran.append("CREATE PROCEDURE byUser_Tran_2()\r\n");
        tmpTran.append("`tran` : BEGIN\r\n");
        tmpTran.append("DECLARE $EffectedCount INT;\r\n");
    ...
    public static java.lang.String[] Tran_3($Ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas) {
        ...
        tmpTran.append("SET GLOBAL innodb_lock_wait_timeout = 50;\r\n");
        StringBuilder tmpBody = new StringBuilder("START TRANSACTION;\r\n");
        result.add("DROP PROCEDURE IF EXISTS byUser_Tran_3;\r\n");
        tmpTran.append("CREATE PROCEDURE byUser_Tran_3()\r\n");
        tmpTran.append("`tran` : BEGIN\r\n");
        tmpTran.append("DECLARE $EffectedCount INT;\r\n");
    ...
    public static java.lang.String[] Tran_4($Ku.by.ToolClass.Sql.TranParamsPackage f_TranParmas) {
        ...
        tmpTran.append("SET GLOBAL innodb_lock_wait_timeout = 50;\r\n");
        StringBuilder tmpBody = new StringBuilder("START TRANSACTION;\r\n");
        result.add("DROP PROCEDURE IF EXISTS byUser_Tran_4;\r\n");
        tmpTran.append("CREATE PROCEDURE byUser_Tran_4()\r\n");
        tmpTran.append("`tran` : BEGIN\r\n");
        tmpTran.append("DECLARE $EffectedCount INT;\r\n");
