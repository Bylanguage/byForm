...
public class Orm0 extends $Ku.by.Object.AbstractOrm {
    ...
    public java.lang.String Member4;
    public java.lang.Integer memberIndex4 = 0;
    ...
    public Orm0($Ku.by.ToolClass.Sql.SelectTable f_SelectTable, $Ku.by.Object.Row f_Row) {
        ...
        this.ormFields.add(new $Ku.by.ToolClass.OrmField("userIcoPath", memberIndex2));
        ...
        this.ormFields.add(new $Ku.by.ToolClass.OrmField("iFileName", memberIndex3));
        AbstractSelectField tmpField4 = f_SelectTable.getSelectItems().get(4);
        memberIndex4 = f_SelectTable.GetIndexOfField(tmpField4);
        this.Member4 = (String)f_Row.getcells().get(memberIndex4).value;
        this.ormFields.add(new $Ku.by.ToolClass.OrmField("iExtendName", memberIndex4));
    ...
    public static $Ku.byUser.Orm.Orm0 create($Ku.by.Object.Row f_Row0, $Ku.by.Object.Row f_Row1) {
